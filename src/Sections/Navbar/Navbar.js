        ...
        <nav>
            ...
            <div className="nav-box">
                ...
                <div className="categories-box">
                    ...
                    <NavbarCategoryLink to={'/'} title={'Home'} svg={IconsData[2].svg} />
                    <NavbarCategoryLink to={'/phones'} title={'Phones'} svg={IconsData[3].svg} />
                    <NavbarCategoryLink to={'/gaming'} title={'Gaming'} svg={IconsData[4].svg} />
                    <NavbarCategoryLink to={'/watches'} title={'Watches'} svg={IconsData[5].svg} />
                    <NavbarCategoryLink to={'/cameras'} title={'Cameras'} svg={IconsData[6].svg} />
                    <NavbarCategoryLink to={'/computers'} title={'Computers'} svg={IconsData[7].svg} />
                    <NavbarCategoryLink to={'/tablets'} title={'Tablets'} svg={IconsData[8].svg} />
                    <NavbarCategoryLink to={'/tvs'} title={'TVs'} svg={IconsData[9].svg} />
...

                    {
                        state ? (
                            ...
                            <NavbarCategoryLink to={'/tools'} title={'Tools'} svg={IconsData[10].svg} />
