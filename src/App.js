        ...
        <CarouselAndShelvesContainer>
          ...
          <ShelvesBox>
            <Routes>
              ...
              <Route
                path="home/foryou/:productId"
                element={<ProductDetails item={ForYouData} />}
              />
              <Route
                path="home/mobilephones/:productId"
                element={<ProductDetails item={MobilePhoneData} />}
              />
              <Route
                path="home/gaming/:productId"
                element={<ProductDetails item={GamingData} />}
              />
              <Route
                path="home/smartwatches/:productId"
                element={<ProductDetails item={SmartWatchesData} />}
              />
              <Route
                path="home/cameras/:productId"
                element={<ProductDetails item={CamerasData} />}
              />
              <Route
                path="home/computers/:productId"
                element={<ProductDetails item={ComputersData} />}
              />
              <Route
                path="home/tablets/:productId"
                element={<ProductDetails item={TabletsData} />}
              />
              <Route
                path="home/tvs/:productId"
                element={<ProductDetails item={TvsData} />}
              />

              <Route path="/phones" element={<Phones />} />
              <Route
                path="phones/google/:productId"
                element={<ProductDetails item={GooglePhonesData} />}
              />
              <Route
                path="phones/samsung/:productId"
                element={<ProductDetails item={SamsungPhonesData} />}
              />
              <Route
                path="phones/apple/:productId"
                element={<ProductDetails item={ApplePhonesData} />}
              />

              <Route path="/gaming" element={<Gaming />} />
              <Route
                path="gaming/sony/:productId"
                element={<ProductDetails item={SonyGamingData} />}
              />

              <Route path="/watches" element={<Watches />} />
              <Route
                path="watches/apple/:productId"
                element={<ProductDetails item={AppleWatchesData} />}
              />

              <Route path="/cameras" element={<Cameras />} />
              <Route
                path="cameras/canon/:productId"
                element={<ProductDetails item={CanonCamerasData} />}
              />

              <Route path="/computers" element={<Computers />} />
              <Route
                path="computers/apple/:productId"
                element={<ProductDetails item={AppleComputersData} />}
              />

              <Route path="/tablets" element={<Tablets />} />
              <Route
                path="tablets/apple/:productId"
                element={<ProductDetails item={AppleTabletsData} />}
              />

              <Route path="/tvs" element={<Tvs />} />
              <Route
                path="tvs/lg/:productId"
                element={<ProductDetails item={LgTvsData} />}
              />

              <Route path="/accessories" element={<Accessories />} />
              <Route
                path="accessories/tools/:productId"
                element={<ProductDetails item={ToolsData} />}
              />
